...
public class MechanicViewFeedback extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<ServiceReviewDetails, HolderServiceReview> recyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Review").child(repEmail);
        ...
        FirebaseRecyclerOptions options = new FirebaseRecyclerOptions
                .Builder<ServiceReviewDetails>()
                .setQuery(databaseReference, ServiceReviewDetails.class)
                .build();

        recyclerAdapter = new FirebaseRecyclerAdapter<ServiceReviewDetails, HolderServiceReview>(options) {
            @Override
